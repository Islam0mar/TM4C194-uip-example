...
third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/IA32_flat/%.o: ../third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/IA32_flat/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
...
third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/IA32_flat/%.o: ../third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/IA32_flat/%.S $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
	@echo 'Invoking: GNU Compiler'
