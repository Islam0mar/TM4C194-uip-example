...
third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/ARM_CRx_No_GIC/%.o: ../third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/ARM_CRx_No_GIC/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
...
third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/ARM_CRx_No_GIC/%.o: ../third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/ARM_CRx_No_GIC/%.S $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
	@echo 'Invoking: GNU Compiler'
