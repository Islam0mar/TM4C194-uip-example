...
third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/STR75x/%.o: ../third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/STR75x/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
