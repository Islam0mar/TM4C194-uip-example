...
third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/ARM_CR5/%.o: ../third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/ARM_CR5/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
...
third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/ARM_CR5/%.o: ../third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/ARM_CR5/%.S $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
	@echo 'Invoking: GNU Compiler'
