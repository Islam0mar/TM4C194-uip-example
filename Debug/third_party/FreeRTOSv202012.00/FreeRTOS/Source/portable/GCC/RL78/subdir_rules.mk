...
third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/RL78/%.o: ../third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/RL78/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
...
third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/RL78/%.o: ../third_party/FreeRTOSv202012.00/FreeRTOS/Source/portable/GCC/RL78/%.S $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
	@echo 'Invoking: GNU Compiler'
